...
public sealed class TvCategorySchemaProvider : ICategorySchemaProvider
{
    ...
    private static readonly CategorySchema TvSchema = new()
    {
        ...
        [
            ...
            new CanonicalAttributeDefinition { Key = "native_resolution", DisplayName = "Native Resolution", ValueType = "string", ConflictSensitivity = ConflictSensitivity.High, Description = "Panel native resolution, for example 3840x2160." },
            new CanonicalAttributeDefinition { Key = "display_technology", DisplayName = "Display Technology", ValueType = "string", ConflictSensitivity = ConflictSensitivity.High, Description = "Panel technology such as OLED, QLED, or Mini LED." },
            ...
            new CanonicalAttributeDefinition { Key = "smart_tv", DisplayName = "Smart TV", ValueType = "boolean", ConflictSensitivity = ConflictSensitivity.Medium, Description = "Whether the television includes a smart TV platform." },
            new CanonicalAttributeDefinition { Key = "smart_platform", DisplayName = "Smart Platform", ValueType = "string", ConflictSensitivity = ConflictSensitivity.Low, Description = "Smart TV operating system or platform." },
            new CanonicalAttributeDefinition { Key = "refresh_rate_hz", DisplayName = "Refresh Rate", ValueType = "integer", Unit = "hz", ConflictSensitivity = ConflictSensitivity.High, Description = "Advertised panel refresh rate in hertz." },
