...
{
    private readonly Dictionary<string, IReadOnlyDictionary<string, string>> mappings;

    public ValueMappingRegistry(IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>>? mappings = null)
    {
        mappings ??= new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.Ordinal)
        {
        ...
        this.mappings = mappings.ToDictionary(
            entry => entry.Key,
            entry => (IReadOnlyDictionary<string, string>)entry.Value.ToDictionary(value => NormaliseValue(value.Key), value => value.Value, StringComparer.Ordinal),
