...
public sealed class ProductExplorerPageTests
{
    ...
    private sealed class FakeThrowingProductClient : IProductNormaliserAdminApiClient
    {
        ...
        public Task<RecurringDiscoveryCampaignDto> UpdateRecurringDiscoveryCampaignConfigurationAsync(string campaignId, UpdateRecurringDiscoveryCampaignConfigurationRequest request, CancellationToken cancellationToken = default) => throw new NotImplementedException();
