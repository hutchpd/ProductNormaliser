...
public interface IAdminQueryService
{
    ...
    Task<ProductListResponse> ListProductsAsync(string? categoryKey, string? search, int? minSourceCount, string? freshness, string? conflictStatus, string? completenessStatus, string? sort, int page, int pageSize, CancellationToken cancellationToken);
